...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/alum_cursos.css">
        <link rel="stylesheet" type="text/css" href="../css/alum_comentarios.css">

        <script type="text/javascript" src="../js/jquery-1.11.1.min.js"></script>
        <script type="text/javascript" src="../js/alumno.js"></script>
        <script type="text/javascript" src="../js/alum_cursos.js"></script>
        <script type="text/javascript" src="../js/alum_comentarios.js"></script>
        ...
        <title>M&oacute;dulo Alumno</title>
    ...
    <body>
        ...
        List<Course> cursos = XMLReader.ReadCoursesXML.ReadCourses(user.getIDCursos(), xmlCourses);
